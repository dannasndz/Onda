        ...
        {!existingReview && !isEditingReview && (
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            <div className="w-full md:w-3/5 lg:w-2/3 flex flex-col space-y-6 justify-center text-center md:text-left">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white mb-1">
                  {song.name}
                </h2>
                <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-3">
                  {song.artist}
                </p>
              ...
              <button
                ...
                className="text-center px-5 py-2.5 rounded-lg text-lg sm:text-xl md:text-2xl font-medium text-white bg-gradient-to-r from-cyan-500 to-purple-500 hover:opacity-90 transition-opacity"
              >
                Crear reseña
              </button>
            </div>
